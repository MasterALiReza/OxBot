        ...
        <?php else:
          ...
          foreach ($payments as $p):
            ...
            <tr>
              ...
              <td data-label="کاربر"><span class="cell-mono"><?= htmlspecialchars($p['id_user'] ?? '—') ?></span></td>
              <td data-label="شناسه تراکنش">
                <span class="cell-mono" style="color:var(--accent)"><?= htmlspecialchars(trunc((string) ($p['id_order'] ?? '—'), 18)) ?></span>
              </td>
