                        ...
                        <td data-label="کاربر" style="text-align: right; padding: 10px 8px; vertical-align: middle;">
                            <div class="dash-unified-content" style="align-items: center; display: flex; gap: 10px; direction: rtl; justify-content: flex-start; width: 100%; min-width: 0;">
                                ...
                                <div style="min-width: 0; display: flex; flex-direction: column; gap: 2px; text-align: right; align-items: flex-start; overflow: hidden;">
                                    <a href="user.php?id=<?= (int)$ref['id'] ?>" class="cm" style="font-family: var(--font); color: var(--text); font-weight: 600; text-decoration: none; max-width: 160px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; display: inline-block;">
