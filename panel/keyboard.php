...
if ($method == "POST" && is_array($keyboard)) {
    ...
    $keyboardmain_default = '{"keyboard":[[{"text":"text_sell"},{"text":"text_extend"}],[{"text":"text_Purchased_services"}],[{"text":"text_usertest"},{"text":"text_Tariff_list"}],[{"text":"accountwallet"},{"text":"text_help"}],[{"text":"text_support"},{"text":"text_affiliates"}],[{"text":"text_wheel_luck"}]]}';
